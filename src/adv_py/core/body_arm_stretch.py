...
def plan_body_arm_stretch(
    ...
    *,
    ...
    return BodyArmStretchPlan("|AdvPy_ArmSettings", tuple(sides))
    ...
    *,
    ...
    for spec in plan.sides:
        ...
        checks = (
            ...
            (state.ratio_name == spec.ratio_name and state.ratio_distance_source == f"{spec.distance_name}.distance" and abs(state.ratio_divisor - spec.rest_length) <= tolerance and state.ratio_operation == 2, "ratio_wiring", "Arm stretch 比例连线不一致"),

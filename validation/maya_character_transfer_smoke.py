...
def main(source,folder,reopen=False,partner=False,prepared=False):
...
if __name__=='__main__':raise SystemExit(main(Path(sys.argv[1]),Path(sys.argv[2]),'--reopen' in sys.argv,'--partner' in sys.argv,'--prepared' in sys.argv))
